...
class SpaceSwitcher():
    ...
    def __init__(self, character, inst):
        ...
        self.widgets["window"] = cmds.window("spaceSwitcherUI", w = 550, h = 400, title = character + "_Space Switcher", sizeable = False)



        #create the main layout

        self.widgets["mainLayout"] = cmds.columnLayout(w = 530)

        self.widgets["scroll"] = cmds.scrollLayout(w = 540, h = 500, hst = -1, parent = self.widgets["mainLayout"])

        self.widgets["topLevelLayout"] = cmds.columnLayout(w = 515, parent = self.widgets["scroll"])
        ...
        self.widgets["leftColumnLayout"] = cmds.rowColumnLayout(parent = self.widgets["topLevelLayout"], nc = 6, cw = [(1, 250), (2, 80), (3, 35), (4, 40), (5, 35), (6, 50)], cat = [(1, "both", 5),(2, "both", 5),(3, "both", 5),(4, "both", 5),(5, "both", 1), (6, "left", 20 )])
    ...
    def createSpaceInfoForControl(self, control, *args):
        ...
        self.widgets[control + "_spaceSwitchSpacesLayout"] = cmds.rowColumnLayout(nc = 3,cw = [(1, 225), (2, 215), (3, 70), ], parent = self.widgets[control + "_spaceSwitch2Rows"], cat = [(1, "both", 5), (2, "both", 5), (3, "both", 10)])
        ...
        for attr in attrs:
            ...
            if cmds.objExists(animControl + "." + attr):
                ...
                print "found anim control value"
                print value, attr, animControl
        ...
        if found:
            ...
            cmds.optionMenu(self.widgets[control.partition(":")[2] + "_spacesOM"], edit = True, v = foundInfo)
    ...
    def switchSpace(self, control, *args):
        ...
        #ensure all spaces are on teh control
        spaceSwitchNode = control.rpartition("_follow")[0]
        ctrl = spaceSwitchNode.rpartition("_space")[0]
        self.forceTransfer(ctrl)
        ...
        if selected == "default":
            ...
            if matching:
                ...
                if matchToControl == False:
                    ...
                    print "setting preframe key " + str(currentTime - 1)
                ...
                try:
                    ...
                    print "did not set the desired space..."
                    pass
                ...
                if matchToControl == False:
                    ...
                    try:
                        constraint = cmds.orientConstraint(tempLoc, control)[0]
                        constraints.append(constraint)
                    except:
                        pass
        ...
        for node in selectNodes:
            ...
            if attrs != None:
                ...
                for attr in reversed(attrs):
                    cmds.lockNode(control, lock = False)
                    cmds.addAttr(control, ln = attr, dv = 0, min = 0, max = 1, keyable = True)
                    #cmds.lockNode(control, lock = True)
    ...
    def forceTransfer(self, control):

        #need to add attr that is on spaceSwitchNode to control
        attrs = []
        node = control + "_space_switcher"
    ...
    def updateUI(self, spaceSwitchers, *args):
        ...
        cmds.button(self.widgets["syncStatusButton"], edit = True, visible = True)
